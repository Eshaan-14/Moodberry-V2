...
const USER_IMAGE_CONFIG: { filename: string; tags?: string[]; description?: string }[] = [
  ...
  { filename: '18-polarbear.jpg', tags: ['hesitant', 'winter', 'wildlife', 'snow', 'sea'], description: 'Polar bear in snowy landscape' },
  ...
  { filename: '27-umbrella.jpg', tags: ['rain', 'weather', 'protection', 'city', 'cheerful'], description: 'Colorful umbrella in rain' },
  ...
  { filename: '38-newspaper.jpg', tags: ['news', 'reading', 'paper', 'vintage', 'stressed'], description: 'Vintage newspaper stack' },
  ...
  { filename: '41-books.jpg', tags: ['reading', 'library', 'knowledge', 'thoughtful', 'paper'], description: 'Stack of old books' },
  ...
  { filename: '45-racing.jpg', tags: ['speed', 'car', 'sport', 'fast', 'competition'], description: 'Race cars on track' },
